...
//	  BST myTree = new BST();
//	  myTree.root = new BST_Node("gamma");
////	  printInOrder(myTree.root);
//	  myTree.root.left = new BST_Node("delta");
//	  printInOrder(myTree.root);
//	  myTree.root.right = new BST_Node("theta");
////	  printInOrder(myTree.root);
//	  myTree.root.left.left = new BST_Node("alpha");
////	  printInOrder(myTree.root);
//	  myTree.root.right.left = new BST_Node("pi");
////	  printInOrder(myTree.root);
//	  
//	  System.out.println(" ");
	  ...
	  System.out.println(myTree2.size);
	  printInOrder(myTree2.root);
